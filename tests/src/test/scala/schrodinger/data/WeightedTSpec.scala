...
import schrodinger.effect.instances.weighted._
import schrodinger.instances.int._
import schrodinger.testkit.weighted._

import scala.concurrent.duration.DurationInt

class WeightedTSpec extends Specification with Discipline with ScalaCheck with TestInstances {
